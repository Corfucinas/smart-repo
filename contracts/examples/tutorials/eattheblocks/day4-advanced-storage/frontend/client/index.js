...
import EatTheBlocksAdvancedStorage from '../build/contracts/eatTheBlocksAdvancedStorage.json'

let web3
let EatTheBlocksAdvancedStorage
...
const initContract = () => {
  const deploymentKey = Object.keys(EatTheBlocksAdvancedStorage.networks)[0]
