          ...
          p = function (t, e) {
            ;(this.eth = t),
              ...
              (this.new = function () {
                ...
                var a = i[i.length - 1]
                if (
                  (r.isObject(a) && !r.isArray(a) && (o = i.pop()),
                  o.value > 0)
                ) {
                  var s =
                    e.filter(function (t) {
          ...
          function n(t) {
              ...
              if (null != n && W(n, 2, 64, R, 'base')) {
                ...
                a
                  ? ((u.s = 1 / t < 0 ? ((c = c.slice(1)), -1) : 1),
                    ...
                    (a = !1))
                  : (u.s =
                      45 === c.charCodeAt(0) ? ((c = c.slice(1)), -1) : 1),
                  (c = p(c, 10, n, u.s))
              } else {
                if (t instanceof e)
                  return (
            ...
            return (
              ...
              (E.toDigits = function (t, n) {
                ...
                return (
                  (t =
                    null != t && W(t, 1, S, 18, 'precision') ? 0 | t : null),
